...
import '../styles/DetailsFilms.css'
const DetailsFilms = () => {
    ...
    const film = films.find((film) => film.id.toString() === filmId);
    ...
    return (
      <div className="details-film">
        ...
        <p><strong>Acteurs:</strong> {film.actor}</p>
        <p><strong>Rôle:</strong> {film.role}</p>
        <p><strong>Description:</strong> {film.description}</p>
        <p><strong>Note:</strong><Rating ratingValue="star" value={film.star}/></p>
